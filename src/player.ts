...
export class Player implements Actor {
    ...
    constructor(private game: Game, public position: Point) {
        ...
        this.keyMap = {};
        this.keyMap[KEYS.VK_W] = this.keyMap[KEYS.VK_NUMPAD8] = 0; // up
        ...
        this.keyMap[KEYS.VK_S] = this.keyMap[KEYS.VK_NUMPAD2] = 4; // down
    ...
    private handleInput(event: KeyboardEvent): boolean {
        ...
        if (code in this.keyMap) {
            ...
            this.game.shoot(this.position.x, this.position.y);
            validInput = true;
        } else {
